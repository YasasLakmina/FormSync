    ...
    const handleGenerate = async () => {
        ...
        try {
            ...
            for (let i = 0; i < generationStages.length; i++) {
                ...
                setStages(prev => prev.map((s, idx) => idx === stageIndex ? { ...s, status: 'loading', progress: 0 } : s));
        ...
        <div className="builder-layout">
            ...
            <div style={{ display: 'flex', flexDirection: 'column', minWidth: 0, flex: 1 }}>
                ...
                <div style={{
                    ...
                    backgroundColor: '#f8f9fa', borderBottom: '1px solid #e5e7eb',
                    flexWrap: 'wrap', justifyContent: 'flex-end', alignItems: 'center', minHeight: '60px'
                }}>
                    {!isFrontendComplete ? (
                        <button
                            ...
                            onMouseEnter={e => { if (!isExporting) { e.currentTarget.style.transform = 'scale(1.05)'; } }}
                            onMouseLeave={e => { if (!isExporting) { e.currentTarget.style.transform = 'scale(1)'; } }}
                        >
                            <Sparkles size={20} />
