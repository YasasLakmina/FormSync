...
export const Documentation: React.FC = () => {
  ...
  const getFilteredNavItems = (groupId: string, items: Array<{ id: string; label: string }>) => {
...
}> = ({ title, groupId, expanded, onToggle, children }) => (
  <div className="mb-4">
    <button
      onClick={onToggle}
...
}> = ({ language, code, filename, copyCode, copiedCode }) => {
