        ...
        <main className="flex-1 px-8 lg:px-16 py-12 max-w-4xl">
          ...
          >
            ...
            <p className="text-lg text-neutral-600 dark:text-neutral-400 mb-12 leading-relaxed">
              Complete guide to building, validating, and optimizing form
              schemas with AI assistance.
            </p>

            <Section id="overview" title="Overview">
              <p className="text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
                FormSync is a web-based platform that helps you create,
                validate, and optimize form schemas with AI assistance. The
                system supports multiple input formats and provides real-time
                quality scoring to ensure your forms meet enterprise standards.
              </p>
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                Whether you're a non-technical user starting with templates or a
                developer building custom schemas, FormSync streamlines the
                entire form creation workflow with intelligent suggestions and
            ...
            <Section id="architecture" title="System Architecture">
              ...
              <div className="grid gap-4">
                <Feature
                  title="Template-Based Form Builder"
                  description="Rapid prototyping with pre-built templates"
                />
                <Feature
                  title="Schema Editor"
                  description="Multi-format support with syntax highlighting"
                />
                <Feature
                  title="AI Enhancement Engine"
                  description="Intelligent suggestions for validation and accessibility"
                />
                <Feature
                  title="Quality Evaluation Engine"
                  description="Continuous assessment across five dimensions"
                />
              </div>
            </Section>
            ...
            <Section id="schema-editor" title="Schema Editor Overview">
              <p className="text-neutral-700 dark:text-neutral-300 mb-4 leading-relaxed">
                The Schema Editor provides a code-based interface for creating
                and modifying form structures. It supports syntax highlighting,
                real-time validation, and format conversion.
              </p>
              <Callout type="info" title="Pro Tip">
                Technical users can write schemas directly while seeing
                immediate feedback on structure and validity.
              </Callout>
            </Section>
            ...
            <Section id="formats" title="Multiple Input Formats">
              ...
              <div className="space-y-4">
                <FormatCard
                  format="JSON"
                  description="Standard format for web applications"
                />
                <FormatCard
                  format="YAML"
                  description="Human-readable format with minimal syntax"
                />
                <FormatCard
                  format="XML"
                  description="Traditional enterprise format"
                />
              </div>
              <p className="text-neutral-700 dark:text-neutral-300 mt-6 leading-relaxed">
                All formats are converted to a standardized internal
            ...
            <Section id="ai-suggestions" title="AI Schema Suggestions">
              <p className="text-neutral-700 dark:text-neutral-300 mb-6 leading-relaxed">
                The AI Enhancement Engine analyzes your schema and generates
              ...
              <Callout type="warning" title="Important">
                All suggestions are optional and require explicit user approval
                before application.
              </Callout>
            </Section>
            ...
            <Section id="quality-scoring" title="Schema Quality Scoring">
              <p className="text-neutral-700 dark:text-neutral-300 mb-6 leading-relaxed">
                Schemas receive a quality score from 0 to 100 based on five
                dimensions:
              </p>
              <div className="space-y-3">
                <ScoreDimension
                  name="Structure"
                  weight="25%"
                  description="Schema organization and validity"
                />
                <ScoreDimension
                  name="Validation"
                  weight="25%"
                  description="Coverage of validation rules"
                />
                <ScoreDimension
                  name="Accessibility"
                  weight="20%"
                  description="Labels, hints, and screen reader support"
                />
                <ScoreDimension
                  name="Consistency"
                  weight="20%"
                  description="Naming conventions and field types"
                />
                <ScoreDimension
                  name="AI Improvement"
                  weight="10%"
                  description="AI enhancement depth"
                />
              </div>
            </Section>
            ...
            <Section id="validation" title="Schema Validation Process">
              ...
              />
              <p className="text-neutral-700 dark:text-neutral-300 mt-6 leading-relaxed">
                Errors are displayed with line numbers and specific guidance for
                resolution.
              </p>
            </Section>
  ...
  "properties": {
    // Your properties here
              ...
              <div className="mt-6 space-y-4">
                <ErrorSolution
                  error="Syntax errors"
                  solution="Check for missing commas or quotes"
                />
                <ErrorSolution
                  error="Type mismatches"
                  solution="Ensure field types are valid"
                />
                <ErrorSolution
                  error="Missing properties"
                  solution="Add required schema properties"
                />
              </div>
            </Section>
            ...
            <Section
              id="best-practices"
              title="Best Practices for High-Quality Schemas"
            >
              <FeatureList
                items={[
              ...
              <Callout type="info" title="Quality Target">
                Aim for a quality score of 80 or higher. Scores above 85
                indicate excellent schema quality.
              </Callout>
            </Section>

            <Section id="export" title="Exporting Schemas">
              <p className="text-neutral-700 dark:text-neutral-300 mb-6 leading-relaxed">
                Enhanced schemas can be copied from the output panel and used
                directly in your application. The schema follows JSON Schema
                standards and is compatible with most form libraries.
              </p>
              <CodeBlock
                language="json"
    ...
    "password": {
      ...
      "pattern": "^(?=.*[a-z])(?=.*[A-Z])(?=.*\\\\d)"
            ...
            <Section id="integration" title="Using Schemas in External Systems">
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                FormSync schemas work with form validation libraries, API
                validators, and database schema tools. Export the final JSON and
            ...
            <Section
              id="comp-templates"
              title="Component: Template-Based Form Builder"
            >
              <p className="text-neutral-700 dark:text-neutral-300 mb-6 leading-relaxed">
            ...
            <Section id="comp-editor" title="Component: Schema Editor">
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                A code editor with syntax highlighting, validation feedback, and
                multi-format support. Suitable for technical users who prefer
            ...
            <Section id="comp-ai" title="Component: AI Enhancement Engine">
              ...
              <Callout type="info" title="Human-in-the-Loop Design">
                All suggestions require user approval, maintaining full control
                over schema changes.
              </Callout>
            </Section>
            ...
            <Section
              id="comp-quality"
              title="Component: Schema Quality Evaluation"
            >
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed">
                Real-time quality scoring across five dimensions. Scores update
                dynamically as suggestions are applied or undone, providing
                immediate feedback on schema improvements.
              </p>
            </Section>
            ...
            <Section id="support" title="Support">
              <p className="text-neutral-700 dark:text-neutral-300 leading-relaxed mb-6">
                For technical support, bug reports, or feature requests, contact
              ...
              <div className="bg-purple-50 dark:bg-purple-950/20 border border-purple-200 dark:border-purple-800 rounded-lg p-6">
                ...
                <p className="text-sm text-purple-700 dark:text-purple-300">
                  Visit our support portal or reach out to our team for
                  assistance with FormSync.
                </p>
              </div>
            </Section>
          </motion.div>
  ...
  const highlightText = (text: string, query: string) => {
    ...
    return parts.map((part, index) =>
      part.toLowerCase() === query.toLowerCase() ? (
        <mark
          key={index}
          className="bg-yellow-200 dark:bg-yellow-500/30 text-neutral-900 dark:text-neutral-100"
        >
          {part}
        </mark>
      ) : (
...
// User Type Card
const UserType: React.FC<{ type: string; description: string }> = ({
  type,
  description,
}) => (
  ...
  <ol className="space-y-3">
    {steps.map((step, index) => (
      ...
      >
        ...
        <span className="text-neutral-700 dark:text-neutral-300 pt-0.5">
          {step}
        </span>
      </motion.li>
    ))}
...
const CodeBlock: React.FC<{
  ...
  return (
    ...
    >
      ...
      <div
        className={`relative bg-neutral-900 dark:bg-neutral-950 ${filename ? "" : "rounded-t-lg"} rounded-b-lg overflow-hidden`}
      >
        <button
...
// Format Card
const FormatCard: React.FC<{ format: string; description: string }> = ({
  format,
  description,
}) => (
  <motion.div
...
const FAQ: React.FC<{ question: string; answer: string }> = ({
  ...
  return (
    ...
    >
      ...
      >
        <h4 className="font-semibold text-neutral-900 dark:text-neutral-100 pr-4">
          {question}
        </h4>
        <motion.div
...
// Error Solution
const ErrorSolution: React.FC<{ error: string; solution: string }> = ({
  error,
  solution,
}) => (
  <motion.div
